...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11787652);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
{gdjs.evtTools.window.openURL("https://ruingamesco.netlify.app", runtimeScene);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11789716);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.MenuCode.GDNewSpriteObjects1.length ;i < len;++i) {
    gdjs.MenuCode.GDNewSpriteObjects1[i].getBehavior("Animation").setAnimationName("NewSprite");
}
}}
